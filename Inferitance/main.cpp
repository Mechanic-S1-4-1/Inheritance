...
public:
	...
	Student
	(
		const std::string& last_name, const std::string& first_name, unsigned int age,          // параметры перенесены из Human для осуществления делегирования "..:Human(last_name,first_name,age)"
